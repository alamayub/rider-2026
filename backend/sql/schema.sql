...
CREATE TABLE IF NOT EXISTS cities (
  ...
  created_by VARCHAR(36) NOT NULL,
  updated_by VARCHAR(36) NOT NULL,
  UNIQUE KEY uniq_city_code (code)
);
...
CREATE TABLE IF NOT EXISTS platform_counters (
  ...
  users_total BIGINT UNSIGNED NOT NULL DEFAULT 0,
  users_active BIGINT UNSIGNED NOT NULL DEFAULT 0,
  users_suspended BIGINT UNSIGNED NOT NULL DEFAULT 0,
  users_banned BIGINT UNSIGNED NOT NULL DEFAULT 0,
  notifications_total BIGINT UNSIGNED NOT NULL DEFAULT 0,
  notifications_sent BIGINT UNSIGNED NOT NULL DEFAULT 0,
  notifications_received BIGINT UNSIGNED NOT NULL DEFAULT 0,
  notifications_delivered BIGINT UNSIGNED NOT NULL DEFAULT 0,
  notifications_read BIGINT UNSIGNED NOT NULL DEFAULT 0,
  updated_at DATETIME NOT NULL
);
