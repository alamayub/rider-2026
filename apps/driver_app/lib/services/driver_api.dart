...
class DriverApi {
  ...
  /// Same OSRM-backed preview as the rider app (`GET /rides/route`).
  Future<DriverDrivingRoute?> getDrivingRoutePreview({
    ...
    try {
      ...
      return DriverDrivingRoute(points: points, distanceKm: distanceKm);
...
class DriverDrivingRoute {
  const DriverDrivingRoute({required this.points, required this.distanceKm});
